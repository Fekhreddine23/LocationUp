...
public class OfferService {
    ...
    public OfferService(OfferRepository offerRepository,
                       ...
                       MobilityServiceRepository mobilityServiceRepository,
    ...
    public OfferDTO createOffer(CreateOfferDTO createOfferDTO) {
        ...
        try {
            ...
            City pickupLocation = cityRepository.findByName(createOfferDTO.getPickupLocationName())
            	    .orElseGet(() -> {
            ...
            City returnLocation = cityRepository.findByName(createOfferDTO.getReturnLocationName())
                    .orElseGet(() -> {
                        City newCity = new City();
            ...
            MobilityService mobilityService = mobilityServiceRepository.findById(createOfferDTO.getMobilityServiceId())
                .orElseThrow(() -> {
                    System.out.println("❌ Service mobilité non trouvé ID: " + createOfferDTO.getMobilityServiceId());
                    return new RuntimeException("Service de mobilité non trouvé avec l'ID: " + createOfferDTO.getMobilityServiceId());
                });
    ...
    private Admin getCurrentAdmin() {
        try {
            ...
            System.out.println("✅ Utilisation de l'admin: " + firstAdmin.getUsername() + " (ID: " + firstAdmin.getAdminId() + ")");
            return firstAdmin;
    ...
    public Object getOffersStats() {
        ...
        double confirmationRate = totalOffers > 0 ?
            (confirmedOffers * 100.0 / totalOffers) : 0;
