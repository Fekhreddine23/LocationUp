...
public class CityController {
	...
	/**
	 * Récupère toutes les villes GET /api/cities
	 */
	@GetMapping
	...
	/**
	 * Récupère une ville par son ID GET /api/cities/{id}
	 */
	@GetMapping("/{id}")
	...
	/**
	 * Récupère une ville par son nom GET /api/cities/name/{name}
	 */
	...
	/**
	 * Supprime une ville par son ID DELETE /api/cities/{id}
	 */
	@DeleteMapping("/{id}")
