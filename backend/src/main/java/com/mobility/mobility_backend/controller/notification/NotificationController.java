...
public class NotificationController {
    ...
    public ResponseEntity<String> sendNotification(@RequestBody NotificationMessage notification) {
        try {
            System.out.println("📤 [CONTROLLER] Envoi notification personnalisée: " + notification.getTitle() + " à: " + notification.getRecipient());
    ...
    public ResponseEntity<String> sendReservationEvent(
        ...
        try {
            System.out.println("🏨 [CONTROLLER] Événement réservation - reservationId: " + reservationId + ", userId: " + userId + ", eventType: " + eventType);
    ...
    public ResponseEntity<String> sendPaymentEvent(
        ...
        try {
            System.out.println("💳 [CONTROLLER] Événement paiement - paymentId: " + paymentId + ", userId: " + userId + ", eventType: " + eventType);
    ...
    public ResponseEntity<String> sendSystemEvent(
            @RequestParam String eventType,
            @RequestParam String message,
            @RequestParam String severity) {

        try {
            System.out.println("🔊 [CONTROLLER] Événement système - eventType: " + eventType + ", message: " + message + ", severity: " + severity);
    ...
    public ResponseEntity<java.util.List<NotificationMessage>> getUserNotifications(
            @PathVariable String userId,
            @RequestParam(required = false) String category,
            @RequestParam(required = false) String severity) {

        try {
            System.out.println("📋 [CONTROLLER] Récupération notifications - userId: " + userId + ", category: " + category + ", severity: " + severity);
            java.util.List<NotificationMessage> notifications = notificationService.getUserNotifications(userId, category, severity);
    ...
    public ResponseEntity<String> markAsRead(
        ...
        try {
            System.out.println("📖 [CONTROLLER] Marquer comme lue - notificationId: " + notificationId + ", userId: " + userId);
    ...
    public ResponseEntity<String> deleteNotification(
        ...
        try {
            System.out.println("🗑️ [CONTROLLER] Suppression notification - notificationId: " + notificationId + ", userId: " + userId);
    ...
    public ResponseEntity<String> sendTestBroadcast(
            @RequestParam String message,
            @RequestParam(required = false, defaultValue = "INFO") String severity) {
