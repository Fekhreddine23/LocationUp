		...
		if (offerRepository.count() == 0) {
			...
			if (cities.size() >= 2 && services.size() >= 1 && admin != null) {
				...
				offer1.setDescription(
						"Vélo électrique parfait pour les déplacements urbains. Batterie longue durée, confortable et facile à utiliser.");
				...
				offer2.setDescription(
						"Scooter 125cc confortable pour tous vos trajets en ville. Idéal pour les déplacements professionnels.");
